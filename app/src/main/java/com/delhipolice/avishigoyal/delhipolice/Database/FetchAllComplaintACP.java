...
import com.delhipolice.avishigoyal.delhipolice.ACP.CompleteAdapter;
import com.delhipolice.avishigoyal.delhipolice.ACP.OurData;
import com.delhipolice.avishigoyal.delhipolice.ACP.PayApproveAdapter;
import com.delhipolice.avishigoyal.delhipolice.ACP.PendingAdapter;
...
public class FetchAllComplaintACP extends AsyncTask<String,String,String> {
    ...
    public FetchAllComplaintACP(String status, Context context, ArrayList<OurData> ourData, RecyclerView recyclerView) {
        this.status = status;
